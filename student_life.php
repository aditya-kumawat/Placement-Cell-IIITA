	...
	<body>
		...
		<div class="row block" id="effe">
			<div class="block-title col s12 valign-wrapper">
				...
				<p class="valign title">Effervescence</p>
		...
		<div class="row block" id="prayaas">
			<div class="block-title col s12 valign-wrapper">
				<span class="valign leftline"></span>
				<p class="valign title">Prayaas</p>
				<span class="valign rightline"></span>
			</div>
			<div class="col s10 offset-s1 body">
				<p>
		...
		<div class="row block" id="gymkhana">
			<div class="block-title col s12 valign-wrapper">
				<span class="valign leftline"></span>
				<p class="valign title">Gymkhana</p>
				<span class="valign rightline"></span>
			</div>
			<div class="col s10 offset-s1 body">
				<p>
		...
		<div class="row block" id="effe">
			<div class="block-title col s12 valign-wrapper">
				<span class="valign leftline"></span>
				<p class="valign title">Workshops,<br>Conferences</p>
				<span class="valign rightline"></span>
			</div>
			<div class="col s10 offset-s1 body">
				<p>
		...
		<div class="row block" id="student_ambassadors">
			<div class="block-title col s12 valign-wrapper">
				<span class="valign leftline"></span>
				<p class="valign title">Student Ambassadors</p>
				<span class="valign rightline"></span>
			</div>
			<div class="col s10 offset-s1 body">
				<p>
		...
		<div class="row block" id="science_conclave">
			<div class="block-title col s12 valign-wrapper">
				<span class="valign leftline"></span>
				<p class="valign title">Science Conclave</p>
				<span class="valign rightline"></span>
			</div>
			<div class="col s10 offset-s1 body">
				<p>
					One of the most eminent and august gathering of noble laureates who give away their enlightening lectures to the students across the globe. The institute has the honor of hosting the grand and ceremonial event where students and professors from all over the world come and participate in a plethora of cultural and scholastic meetings and performances.
				</p>
			</div>
		</div>
